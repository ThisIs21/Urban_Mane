        ...
        <div>
                ...
                {loading ? (
                  ...
                  products.map((product) => (
                    <tr key={product.id} className="border-b hover:bg-opacity-50" style={{ borderColor: 'var(--color-border)' }}>
                      ...
                      <td className="p-4 text-white font-semibold">Rp {product.price.toLocaleString()}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 rounded hover:bg-blue-600/20"
                            style={{ color: '#3b82f6' }}
                            title="Edit"
                          >
                            ✎
                          ...
                          <button
                            ...
                            className="p-2 rounded hover:bg-red-600/20"
          ...
          >
            <form onSubmit={handleSubmitProduct} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold uppercase mb-1" style={{ color: 'var(--color-muted)' }}>Foto Product</label>
                <input
                  type="file"
                  accept="image/*"
                ...
                {servicesLoading ? (
                  ...
                  services.map((service) => (
                    <tr key={service.id} className="border-b hover:bg-opacity-50" style={{ borderColor: 'var(--color-border)' }}>
                      ...
                      <td className="p-4 text-white font-semibold">Rp {service.price.toLocaleString()}</td>
                      <td className="p-4" style={{ color: 'var(--color-muted)' }}>{service.duration} menit</td>
                      <td className="p-4">
